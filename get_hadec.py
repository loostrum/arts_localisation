...
from convert import ra_to_ha, ha_to_proj
...
if __name__ == '__main__':
    ...
    posang_best = ha_to_proj(CB_best_center.ra, CB_best_center.dec)
    posang_00 = ha_to_proj(CB00_center.ra, CB00_center.dec)

    print("Best CB apparent HA, Dec, posang: ({:.5f}, {:.5f}), {:.5f}".format(CB_best_center.ra, CB_best_center.dec, posang_best))
    print("CB00 apparent HA, Dec, posang: ({:.5f}, {:.5f}), {:.5f}".format(CB00_center.ra, CB00_center.dec, posang_00))
